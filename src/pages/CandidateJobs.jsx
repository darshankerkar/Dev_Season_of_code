...
export default function CandidateJobs() {
    ...
    useEffect(() => {
        ...
        // Use preloaded jobs if available
        if (currentUser && preloaded?.jobs && preloaded.jobs.length > 0) {
            ...
            setLoading(false);
        } else if (currentUser && preloaded?.ready) {
            // Preload finished but no jobs — fetch manually
            fetchJobsAndApplications();
        }
    }, [currentUser, navigate, preloaded?.jobs, preloaded?.ready]);
